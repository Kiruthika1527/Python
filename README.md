...
## Project Overview
This project analyzes a Food data Analysis using Python, Pandas, NumPy, and OpenPyXL. It categorizes menu items, calculates nutritional summaries, performs category-wise analysis, and exports the cleaned dataset to an Excel file.
